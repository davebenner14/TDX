...
function ProudlyCanadianBadge() {
  return (
    <div className="proudlyCanadianBadge" aria-label="Proudly Canadian">
      <div className="proudlyCanadianWriting">
        <span className="proudlyCanadianText">Proudly Canadian</span>

        <span className="proudlyCanadianFlag" aria-hidden="true">
          🇨🇦
        </span>

        <span
          className="proudlyCanadianSparkle sparkleOne"
          aria-hidden="true"
        >
          ✦
        </span>
        ...
        <span
          className="proudlyCanadianSparkle sparkleTwo"
          aria-hidden="true"
        >
          ✦
        </span>
        ...
        <span
          className="proudlyCanadianSparkle sparkleThree"
          aria-hidden="true"
        >
          ✧
        </span>
