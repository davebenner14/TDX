      ...
      <main className="site">
        ...
        <section className="videoFeature snapSection">
          <div className="videoFeatureText">
            ...
            <p>
              Helping organizations leverage artificial intelligence,
              automation, and software to operate more efficiently and scale
              with confidence.
            </p>
        ...
        <section className="flowSection snapSection">
          ...
          <div className="flowContent">
            ...
            <p>
              We help organizations turn disconnected tools, manual processes,
              and fragmented information into intelligent systems that move work
              forward.
            </p>
          ...
          <div id="services" className="serviceCards">
            ...
            <article className="serviceCard">
              ...
              <div className="serviceCardOverlay">
                <h3>Automation</h3>
                <p>
                  Connected workflows that reduce manual work, improve
                  efficiency, and keep business operations moving.
                </p>
              </div>
            </article>
            ...
            <article className="serviceCard">
              ...
              <div className="serviceCardOverlay">
<h3>Web Development</h3>                <p>
                  Modern websites, applications, and software platforms built
                  for usability, performance, and growth.
                </p>
              </div>
            </article>
